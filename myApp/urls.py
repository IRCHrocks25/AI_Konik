...
urlpatterns = [
    ...
    path("agent-admin/", views.agent_admin_dashboard, name="agent_admin_dashboard"),
    ...
    path("agent-admin.html", legacy_redirect("/agent-admin/"), name="legacy_agent_admin_html"),
    path("admin-dashboard.html", legacy_redirect("/admin-dashboard/"), name="legacy_admin_dashboard_html"),
    re_path(
        r"^(?:.*/)?(?P<page>(index|dashboard|agents|agent-chat|prompts|industries|events|tools|consulting|billing|profile|settings|login|register|prompt-import|agent-admin)\.html)$",
