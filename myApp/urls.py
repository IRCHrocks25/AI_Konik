...
urlpatterns = [
    ...
    path("dashboard/assistants/", views.assistant_list, name="assistant_list"),
    path("dashboard/assistants/new/", views.assistant_form, name="assistant_new"),
    path("dashboard/assistants/<int:pk>/", views.assistant_form, name="assistant_edit"),
    path("dashboard/assistants/<int:pk>/delete/", views.assistant_delete, name="assistant_delete"),
    ...
    path("embed/sop-assistant.js", views.embed_assistant_loader, name="embed_assistant_loader"),
    path("embed/assistant/<slug:slug>/", views.embed_assistant_frame, name="embed_assistant_frame"),
    path("api/embed/chat/<slug:slug>/", views.embed_assistant_chat, name="embed_assistant_chat"),
